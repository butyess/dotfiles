...
vim.api.nvim_set_hl(0, 'MiniTablineCurrent', { fg = '#ffffff', bg = '#0000ff' })
vim.api.nvim_set_hl(0, 'MiniTablineVisible', { fg = '#f4f9ff', bg = '#2f6fad' })
vim.api.nvim_set_hl(0, 'MiniTablineHidden', { fg = '#d8e5f2', bg = '#1b3550' })
vim.api.nvim_set_hl(0, 'MiniTablineModifiedCurrent', { fg = '#ffffff', bg = '#0000ff', bold = true, italic = true })
vim.api.nvim_set_hl(0, 'MiniTablineModifiedVisible', { fg = '#f4f9ff', bg = '#2f6fad', bold = true, italic = true })
vim.api.nvim_set_hl(0, 'MiniTablineModifiedHidden', { fg = '#d8e5f2', bg = '#1b3550', bold = true, italic = true })
